        ...
        <section id="home" className="mt-20 pt-20 pb-40 px-4 bg-gradient-to-br from-blue-600 to-indigo-900 text-white">
            <div className="max-w-7xl mx-auto">
                <div className="text-center">
                    ...
                    <p className="text-xl mb-8">Simplify your cloud decisions with AI-based cost calculators and service comparisons for AWS, Azure, Google Cloud, and Oracle Cloud.</p>
